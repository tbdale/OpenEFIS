// airspeed_xplane.h: Class definition for the airspeed data reader for X-Plane simulation
//
...
class airspeed_xplane : public airspeed_hardware
{
    public:
        float   vgrnd, vvi;
        /**
        ...
        airspeed_xplane(void);

        virtual ~airspeed_xplane () {}
    protected:
        unsigned        oversample_counter;
};

const unsigned AIRSPEED_SAMPLE_RATE=5; // 5 samples per second
